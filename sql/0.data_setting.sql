...
source /docker-entrypoint-initdb.d/data/emp.sql ;
SELECT 'LOADING dept.sql' as 'INFO';
source /docker-entrypoint-initdb.d/data/dept.sql ;
SELECT 'LOADING emp_hist1.sql' as 'INFO';
source /docker-entrypoint-initdb.d/data/emp_hist1.sql ;
SELECT 'LOADING emp_hist2.sql' as 'INFO';
source /docker-entrypoint-initdb.d/data/emp_hist2.sql ;
SELECT 'LOADING grade.sql' as 'INFO';
source /docker-entrypoint-initdb.d/data/grade.sql ;
SELECT 'LOADING sal1.sql' as 'INFO';
source /docker-entrypoint-initdb.d/data/sal1.sql ;
SELECT 'LOADING sal2.sql' as 'INFO';
source /docker-entrypoint-initdb.d/data/sal2.sql ;
SELECT 'LOADING sal3.sql' as 'INFO';
source /docker-entrypoint-initdb.d/data/sal3.sql ;
SELECT 'LOADING sal4.sql' as 'INFO';
source /docker-entrypoint-initdb.d/data/sal4.sql ;
SELECT 'LOADING sal5.sql' as 'INFO';
source /docker-entrypoint-initdb.d/data/sal5.sql ;
SELECT 'LOADING sal6.sql' as 'INFO';
source /docker-entrypoint-initdb.d/data/sal6.sql ;
